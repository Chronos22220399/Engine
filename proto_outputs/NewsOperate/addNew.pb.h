...
#ifndef GOOGLE_PROTOBUF_INCLUDED_addNew_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_addNew_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:ResultResponse) */ {
 public:
  ...
  ResultResponse* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
...
/* @@protoc_insertion_point(class_definition:NewInfo) */ {
 public:
  ...
  NewInfo* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
...
inline void NewInfo::set_allocated_author_photor(std::string* value) {
  ...
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.author_photor_.IsDefault()) {
...
inline void NewInfo::set_allocated_referring(std::string* value) {
  ...
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.referring_.IsDefault()) {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_addNew_2eproto_2epb_2eh
